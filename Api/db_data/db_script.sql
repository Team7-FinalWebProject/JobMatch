...
1	adminuser	testuser1	Hey buddy send feedback on the new implementation
2	adminuser	testuser2	Welcome onboard our website. We hope you enjoy our services !
\.
...
23	Lubomir	Ivanov	Pernik, Bulgaria	68	Experienced miner with a strong background in mining operations and safety protocols. Skilled in operating heavy machinery and ensuring efficient extraction of resources.	\N	f	active
\.
...
68	miner84	f	\\x34303161653462353130636139313635316364626334613731343039323261643235363130356438346565646233346334326635623137343633613865393863
\.
...
SELECT pg_catalog.setval('jobmatch.messages_id_seq', 2, true);
...
SELECT pg_catalog.setval('jobmatch.professionals_id_seq', 23, true);
...
SELECT pg_catalog.setval('jobmatch.users_id_seq', 68, true);
